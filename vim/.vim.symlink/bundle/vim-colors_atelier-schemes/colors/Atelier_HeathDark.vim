...
call <sid>hi("VertSplit",     s:gui03, s:gui01, s:cterm03, s:cterm01, "none", "")
...
call <sid>hi("Todo",         s:gui06, s:gui08, s:cterm0A, s:cterm01, "", "")
...
call <sid>hi("rubyString",                  s:gui0B, "", s:cterm0B, "", "", "")
...
call <sid>hi("Nbsp",         "", s:gui00, "", s:cterm00, "undercurl", s:gui08)
