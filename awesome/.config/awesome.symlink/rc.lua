...
awful.screen.connect_for_each_screen(function(s)
    ...
    if single_screen then
      awful.tag({ 1, 2, 3, 4, 5, 6, 7, 8, 9, "f1", "f2", "f3", "f4", "f5", "f6", "f7", "f8", "f9", "f10", "f11", "f12"}, s, awful.layout.layouts[2])
    else
...
awful.rules.rules = {
    ...
    { rule = { class = "Mate-panel" }, properties = { ontop = true, focusable = false, border_width = 0 } },
